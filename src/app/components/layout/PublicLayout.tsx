...
export function PublicLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'Inter', system-ui, sans-serif", background: "#F8F9FB" }}>
      {/* Header */}
      <header
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="px-5 h-10 font-semibold text-sm rounded-[10px] transition-all"
              style={{
        ...
        {mobileOpen && (
          <div
            ...
            style={{ borderTop: "1px solid rgba(226,232,240,0.6)", background: "rgba(255,255,255,0.9)" }}
          >
            {navLinks.map((link) => (
              <button
                key={link.path}
            ...
            <button
              onClick={() => navigate("/login")}
              className="w-full h-10 font-semibold text-sm rounded-[10px]"
              style={{
